...
bool printToFile() {
    ...
    SYSTEMTIME now;
    GetLocalTime(&now);
    logfile << "Date: " << std::setw(2) << std::setfill('0') << now.wDay << "." << std::setw(2) << std::setfill('0') << now.wMonth << "." << std::setw(2) << std::setfill('0') << now.wYear << std::endl;
    logfile << "Start, End" << std::endl;
    ...
    for (int i = 0; i < times_start.size(); i++) {
        ...
        if (i < times_end.size()) {
            ...
            logfile << std::setw(2) << std::setfill('0') << time_end.wHour << ":" << std::setw(2) << std::setfill('0') << time_end.wMinute << std::endl;;
            ...
            //logfile << std::setfill(L'0') << work_h << ":" << std::setw(2) << std::setfill(L'0') << work_m;
        }
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    if (oninit) {
        ...
        /*std::ofstream logfile;
        logfile.open("output.log");
        logfile << "This file was automatically generated by worktime-monitor.";
        logfile.close();*/
    ...
    /*if (somethingChanged) {
        ...
        logfile.open("output.log");
        SYSTEMTIME now;
        std::string writeToFileString = "test";//std::setw(2) << std::setfill(L'0') << now.wDay << "." << std::setw(2) << std::setfill(L'0') << now.wMonth << "." << std::setw(2) << std::setfill(L'0') << now.wYear;
        logfile << writeToFileString;
        logfile.close();
    }*/
